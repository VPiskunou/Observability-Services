...
sudo sed 's|Server=127.0.0.1|Server=192.168.80.6|g' -i /etc/zabbix/zabbix_agentd.conf
...
sudo sed 's|ServerActive=127.0.0.1|ServerActive=192.168.80.6:10051|g' -i /etc/zabbix/zabbix_agentd.conf
